...
def run():
    ...
    print("Temp Time : ", time.time() - temp_start_form)
    ...
    if request.form['target_length'] == 'raw':
        ...
        screw_string = request.form['target_file']
    ...
    if (result['Screw']['Thread_Diameter'] > 3.55 and result['Screw']['Thread_Diameter'] < 3.60) and (
            ...
            result['Screw']['Head_Diameter'] > 4.475 and result['Screw']['Head_Diameter'] < 4.5):
        status = 'Pass'
    else:
        status = 'Fail'
    ...
    print('*******************firebase time******************', time.time() - firebase_time)
